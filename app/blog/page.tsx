      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div className="lg:col-span-6 flex flex-col justify-between">
                  <div>
                    <div className="flex flex-wrap items-center gap-3 mb-4">
                      ...
                      <span className="inline-flex items-center gap-1 text-xs font-mono text-ink/65 bg-[#faf9f6] px-2.5 py-1 rounded-full border border-border/80">
                        <Clock className="size-3 text-teal" />
                        {featuredPost.readingTimeMinutes} min read
                      </span>
                      <span className="text-xs font-mono text-ink/65">
                  ...
                  <div className="flex flex-wrap items-center justify-between gap-4 pt-4 border-t border-border/60">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-ink/65 font-mono">{featuredPost.author.role}</p>
                      </div>
                    </div>
        ...
        <div className="mb-16">
          <div className="flex items-center justify-between mb-8 pb-4 border-b border-border/80">
            ...
            <span className="text-xs font-mono text-ink/65">{posts.length} articles published</span>
          </div>
          ...
          {remainingPosts.length === 0 && !featuredPost && (
            <div className="text-center py-16 bg-white rounded-2xl border border-border p-8">
              ...
              <p className="text-ink/65 text-sm">New articles generated by the Minions.AI pipeline will appear here automatically.</p>
            </div>
          )}
                ...
                <div>
                  ...
                  <div className="p-6">
                    <div className="flex items-center justify-between gap-2 mb-3">
                      ...
                      <span className="text-xs font-mono text-ink/65 flex items-center gap-1">
