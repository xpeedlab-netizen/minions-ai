  ...
  return (
    <Section tone="cream" width="wide" density="feature">
      ...
      <ul className="mt-10 grid sm:grid-cols-3 gap-6">
        {problemCards.map((c, i) => (
          <Reveal key={c.title} delay={i * 0.08} className="h-full">
            <li className="flex h-full flex-col rounded-2xl border border-border bg-white p-6 shadow-sm hover:border-teal/40 transition-colors">
              <h4 className="font-heading font-bold text-ink text-lg">{c.title}</h4>
      ...
      <div className="mt-20">
        ...
        <p className="mt-4 text-lg text-ink/70 leading-relaxed max-w-3xl">
          ...
          {CONTRACTOR_DAY_TIMELINE.map((item, i) => (
            <Reveal key={item.time} delay={i * 0.08}>
              <li className="relative pl-8 sm:pl-10">
                {/* Spine node */}
                <span
                  className="absolute left-0 top-2 size-4 rounded-full border-2 border-teal bg-cream sm:left-[3px]"
                  aria-hidden
                />
                ...
                <div className="rounded-3xl border border-border bg-white p-5 sm:p-8 shadow-sm">
                  ...
                  <div className="grid sm:grid-cols-2 gap-4 sm:gap-6">
                    {/* Without */}
                    <div className="rounded-2xl bg-cream border border-coral-text/25 p-5 space-y-2">
                    ...
                    {/* With */}
                    <div className="rounded-2xl bg-cream border border-teal/40 p-5 space-y-2 shadow-sm">
