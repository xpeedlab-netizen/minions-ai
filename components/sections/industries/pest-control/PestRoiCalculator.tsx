      ...
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mx-auto text-center space-y-3 mb-12">
          <div className="inline-flex items-center gap-2 rounded-full bg-teal/10 border border-teal/30 px-3.5 py-1 font-mono text-xs font-bold text-teal uppercase tracking-wider">
            ...
            <span>Interactive Pest Control LTV Recovery Calculator</span>
          </div>
          <h2 className="font-heading font-extrabold text-3xl sm:text-4xl text-ink text-balance leading-tight">
            How much recurring subscription LTV is your pest control company leaking in missed calls?
          </h2>
          <p className="text-base text-ink/70 max-w-2xl mx-auto">
            Adjust the sliders below based on your call volume to calculate how much annual recurring LTV Minions AI can capture for your company.
          </p>
        </div>
        ...
        <div className="relative rounded-[32px] border-4 border-ink/10 bg-ink p-6 sm:p-10 text-white shadow-2xl overflow-hidden grid lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 relative z-10">
            ...
            {/* Ticket Mix Selector */}
            <div className="space-y-2">
              <span className="text-xs font-mono text-white/70">Customer Lifetime Value (LTV) Mix:</span>
              <div className="grid grid-cols-3 gap-2">
                {[
                  { label: "One-Off ($240)", val: 240 },
                  { label: "Quarterly LTV ($2,275)", val: 2275 },
                  { label: "Termite LTV ($4,500)", val: 4500 },
                ].map((t) => (
                  <button
                    key={t.val}
                    type="button"
