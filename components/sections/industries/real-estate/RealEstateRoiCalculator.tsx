...
export default function RealEstateRoiCalculator() {
  ...
  const [medianPrice, setMedianPrice] = useState(550000); // $550k median home price
  const [commissionRate, setCommissionRate] = useState(2.75); // 2.75% commission rate
  const [closeRate, setCloseRate] = useState(15); // 15% conversion from qualified inquiry to closed deal
  ...
  const annualMinionsCost = 5988; // ~$499/mo starter plan
      ...
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mx-auto text-center space-y-3 mb-10">
          <div className="inline-flex items-center gap-2 rounded-full bg-teal/10 border border-teal/30 px-3.5 py-1 font-mono text-xs font-bold text-teal uppercase tracking-wider">
            ...
            <span>Brokerage Commission ROI Calculator</span>
          </div>
        ...
        <div className="relative rounded-[32px] border border-white/10 bg-ink/95 backdrop-blur-2xl p-5 sm:p-10 text-white shadow-2xl overflow-hidden grid lg:grid-cols-12 gap-8 items-center ring-1 ring-white/10">
          ...
          <div className="lg:col-span-7 space-y-6 relative z-10">
            ...
            <div className="space-y-2">
              <span className="text-xs font-mono text-white/70">Median Market Home Price:</span>
