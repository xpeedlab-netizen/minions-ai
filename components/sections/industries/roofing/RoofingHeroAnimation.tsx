...
const ROOFING_SCENARIOS = [
  {
    id: 0,
    title: "01. Post-Hail Storm Surge Call",
    ...
    logs: [
      "Rex answered call on 1st ring during 200+ call storm surge",
      "Triaged roof damage severity & confirmed home address",
      "Quoted emergency tarping dispatch fee & verified insurance carrier",
    ],
  },
  {
    id: 1,
    title: "02. Insurance Claim Intake",
    ...
    ticketEst: "$18,500 Full Roof Claim Potential",
    logs: [
      'Captured carrier info: "State Farm • Policy #SF-88921"',
      "Dispatched Zip text with instant roof photo upload link",
      "Zip: Homeowner uploaded 3 photos of punctured shingles",
    ],
  },
  {
    id: 2,
    title: "03. Roof Inspection Booked",
    shortName: "ST Synced",
    ...
    logs: [
      "Inspection slot locked into ServiceTitan / Jobber calendar",
      "Sent confirmation SMS with roof estimator arrival tracking link",
      "Paged senior inspector Mark with complete insurance intake file",
    ],
  },
  {
    id: 3,
    ...
    logs: [
      "Roofing crew completed architectural shingle install",
      'Gia sent 1-click Google Review SMS: "Thanks David!"',
...
export default function RoofingHeroAnimation() {
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      setActiveStage((prev) => (prev + 1) % ROOFING_SCENARIOS.length);
    }, 4500);
    return () => clearInterval(interval);
  }, [isAutoPlaying]);

  const scenario = ROOFING_SCENARIOS[activeStage];
        ...
        <div className="flex items-center justify-between border-b border-white/10 pb-2.5">
          <div className="flex items-center gap-2">
            {activeStage === 0 ? (
              ...
              <Home className="size-4 text-teal" />
            )}
          ...
          >
            ...
            <div className="space-y-2">
              <p className="font-mono text-[10px] uppercase tracking-wide text-white/40 flex items-center gap-1.5">
                ...
                Rex Storm Dispatch Log Execution
              </p>
