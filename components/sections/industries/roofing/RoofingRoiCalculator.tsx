...
export default function RoofingRoiCalculator() {
  ...
  const [avgTicket, setAvgTicket] = useState(14500); // $14,500 blended avg replacement ticket
          ...
          <div className="lg:col-span-7 space-y-6 relative z-10">
            ...
            <div className="space-y-2">
              ...
              <div className="flex justify-between text-[10px] font-mono text-white/40">
                <span>5 Calls</span>
                <span>30 Calls</span>
                <span>60 Calls (Storm Surge)</span>
              </div>
            </div>

            {/* Ticket Mix Selector */}
            <div className="space-y-2">
              <span className="text-xs font-mono text-white/70">Average Claim Ticket Mix:</span>
              <div className="grid grid-cols-3 gap-2">
                {[
                  { label: "Repair ($1,200)", val: 1200 },
                  { label: "Blended ($14,500)", val: 14500 },
                  { label: "Full Roof ($22,000)", val: 22000 },
                ].map((t) => (
                  <button
                    key={t.val}
                    type="button"
